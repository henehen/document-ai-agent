# ============================================
# Document AI Agent - Terminal Version v1.1
...
GROQ_API_KEY = os.getenv("GROQ_API_KEY")# ---- COLORS ----
GREEN  = "\033[92m"
BLUE   = "\033[94m"
YELLOW = "\033[93m"
RED    = "\033[91m"
...
def load_documents(folder_path):
    ...
    print(f"{GREEN}✅ Successfully loaded {len(found)} document(s)!{RESET}")
    return documents

def build_memory(documents):
    """Build AI searchable memory from documents"""
...
{RESET}""")
    ...
    if history:
        ...
        print(f"{CYAN}Type 'clear' to start fresh{RESET}")
...
{RESET}""")
    ...
    while True:
        ...
        if question.lower() == "exit":
            ...
            print(f"\n{GREEN}Goodbye! Conversation saved! 👋{RESET}")
            break
